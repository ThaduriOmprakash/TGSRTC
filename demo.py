...
if selection == "Daily Depot Input Sheet":
    ...
    # Display Category - always visible
        ...
        with col9:
                ...
                st.metric("% Day weekly off", f"{Day_weekly_off_per}% / {Day_weekly_off_Benchmark}%")
        ...
        try:
            ...
            if conn:
                ...
                if percentages:
                    ...
                    with col9:
                        st.markdown(f" % Weekly Off (Last 30 Entries): {Mon_weekly_off_per}% / {Day_weekly_off_Benchmark }%") 
        ...
        with col10:
            ...
            st.metric("% Day special off", f"{Day_special_off_per}% / {Benchmark}%")    
            ...
            try:
                ...
                if conn:
                    ...
                    if percentages:
                        ...
                        with col10:
                            st.markdown(f"% Special Off (Last 30 Entries): {Mon_special_off_per}%/ {Benchmark}")
        ...
        with col11:
            ...
            st.metric("% Day Others & OD", f"{Day_other_per}%  / {Benchmark}%")    
        ...
        try:
            ...
            if conn:
                ...
                if percentages:
                    ...
                    with col11:
                        st.markdown(f"% Others & OD (Last 30 Entries): {Mon_other_per}% / {Benchmark}%")
        ...
        with col12:
            ...
            st.metric("% Leave & Absent", f"{Day_leave_absent_per}% / {Benchmark}%") 
        try:
            conn = get_connection()
            if conn:
                cursor = conn.cursor()
                ...
                if percentages:
                    ...
                    with col12:
                        st.markdown(f"% Leave & Absent (Last 30 Entries): {Mon_leave_absent_per}% / {Benchmark}%")
        ...
        with col13:
            ...
            st.metric("% Sick Leave", f"{Day_sick_leave_per}% /{Benchmark}%") 
        try:
            conn = get_connection()
            if conn:
                cursor = conn.cursor()
                ...
                if percentages:
                    ...
                    with col13:
                        st.markdown(f"% Sick Leave (Last 30 Entries): {Mon_sick_leave_per}%/ {Benchmark}%")
                else:
                    with col13:
                        st.warning("⚠️ No data found in the last 30 entries.")
        except Error as e:
        ...
        st.metric("% Spot Absent", f"{Day_spot_absent_per}% / {s_Benchmark:}%") 
        try:
            conn = get_connection()
            if conn:
                cursor = conn.cursor()
                ...
                if percentages:
                    ...
                    st.markdown(f"% Spot Absent (Last 30 Entries): {Mon_spot_absent_per}% / {s_Benchmark}%")
        ...
        with col22:
            ...
            st.metric("% Double Duty", f"{Day_double_duty_per}% / {Benchmark}%") 
            ...
            try:
                ...
                if conn:
                    ...
                    if percentages:
                        ...
                        with col22:
                            st.markdown(f"% Double Duty (Last 30 Entries): {Mon_double_duty_per}% / {Benchmark}%")
                    else:
                        with col22:
                            st.warning("⚠️ No data found in the last 30 entries.")
            except Error as e:
        ...
        with col23:
            ...
            st.metric("% Off Cancellation", f"{Day_off_cancellation_per}% / {Benchmark}%") 
        try:
            conn = get_connection()
            if conn:
                cursor = conn.cursor()
                ...
                if percentages:
                    ...
                    with col23:
                        st.markdown(f"% Off Cancellation (Last 30 Entries): {Mon_off_cancellation_per}% / {Benchmark}%")
